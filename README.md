...
which reads the OpenReview API); see [MIDL/README.md](MIDL/README.md).
...
- **Paper Page** (MICCAI / MIDL) — the per-paper detail page the record was
  scraped from (the OpenReview forum page for MIDL).
